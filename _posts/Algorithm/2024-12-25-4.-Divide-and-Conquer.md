...
Then, any congituous subarray $$ A[i..j] $$ of $$ A[low..high] $$ must lie in exactly one of the following places:
...
>&nbsp;4&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;$$ (left\text{-}low, \ left\text{-}high, \ left\text{-}sum) = $$ FIND-MAXIMUM-SUBARRAY($$ A, \ low, \ mid $$)  
>&nbsp;5&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;$$ (right\text{-}low, \ right\text{-}high, \ right\text{-}sum) = $$ FIND-MAXIMUM-SUBARRAY($$ A, \ mid + 1, \ high $$)  
>&nbsp;6&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;$$ (cross\text{-}low, \ cross\text{-}high, \ cross\text{-}sum) = $$ FIND-MAX-CROSSING-SUBARRAY($$ A, \ low, \ mid, \ high $$)  
>&nbsp;7&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;if $$ left\text{-}sum \ge right\text{-}sum $$ and $$ left\text{-}sum \ge cross\text{-}sum $$  
>&nbsp;8&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return ($$ left\text{-}low, \ left\text{-}high, \ left\text{-}sum $$)  
>&nbsp;9&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;elseif $$ right\text{-}sum \ge left\text{-}sum $$ and $$ right\text{-}sum \ge cross\text{-}sum $$  
