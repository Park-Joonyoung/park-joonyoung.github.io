...
tags: [dynamic-programming, rod-cutting-problem, subproblem-graph, matrix-chain-multiplication, longest-common-subsequence]     # TAG names should always be lowercase
math: true
pin: false
---
